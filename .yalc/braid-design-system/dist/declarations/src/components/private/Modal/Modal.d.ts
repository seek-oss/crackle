...
export declare const Modal: ({ id, open, children, description, onClose, width, closeLabel, illustration, title, headingLevel, position, data, }: ModalProps) => JSX.Element | null;
