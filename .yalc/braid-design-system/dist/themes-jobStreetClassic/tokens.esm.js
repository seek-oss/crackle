import { g as getLightVariant, a as getAccessibleVariant, i as isLight } from "../utils-index.esm.js";
import "../css-responsiveStyle.esm.js";
import merge from "lodash/merge";
import { mix, darken, lighten, tint } from "polished";
  ...
  const tokens2 = {
    ...
    border: {
      ...
      color: {
        ...
        info: info2,
        infoLight: mix(0.3, info2, getLightVariant(info2)),
        positive,
    ...
    color: {
      foreground: {
        ...
        formAccent,
        info: getAccessibleVariant(info2),
        link,
        linkHover,
        linkVisited,
        neutral: grey1,
      ...
      background: {
        ...
        info: info2,
        infoLight: getLightVariant(info2),
        input: white,
        inputDisabled: grey5,
        neutral,
